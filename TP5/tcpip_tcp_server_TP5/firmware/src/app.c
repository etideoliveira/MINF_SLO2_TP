...
//                    lcd_gotoxy(1, 4); // Positionne le curseur à la première ligne
//                    printf_lcd("IP:%d.%d.%d.%d", ipAddr.v[0], ipAddr.v[1], ipAddr.v[2], ipAddr.v[3]);
        ...
        case APP_TCPIP_SERVING_CONNECTION:
        {
            ...
            for (w = 0; w < wMaxGet; w += sizeof (AppBuffer)) {
                ...
                GetMessage( (uint8_t*)AppBuffer, &RemoteParamGen, &ipSave);
                ...
                SendMessage(AppBuffer, &RemoteParamGen, ipSave);
